...
window.addEventListener('scroll', () =>
{
    ...
    if(newSection != currentSection)
    {
        ...
        // Add this for text animation
        const content = document.querySelector(`.section:nth-child(${currentSection + 1})`)
        gsap.from(content, {
            duration: 1,
            y: 30,
            opacity: 0,
...
// Ensure DOM is loaded before starting the effect
